...
class showQuestions2 : AppCompatActivity() {
    private lateinit var QuizName : String
    private lateinit var database: DatabaseReference

    private lateinit var binding: ActivityShowQuestions2Binding
   ...
   //     setContentView(R.layout.activity_show_questions)
        ...
        binding = ActivityShowQuestions2Binding.inflate(layoutInflater)
        ...
        binding.answerBtn12.setOnClickListener {
            ...
            binding.answerBtn12.setBackgroundColor(Color.DKGRAY)

            countdownSecond()
            //       finish()
        }

        binding.answerBtn22.setOnClickListener {
            ...
            binding.answerBtn22.setBackgroundColor(Color.DKGRAY)
        ...
        binding.answerBtn32.setOnClickListener {
            ...
            binding.answerBtn32.setBackgroundColor(Color.DKGRAY)
   ...
   /*     binding.testBtn2.setOnClickListener {
    ...
    fun readQuestions2(){
        ...
        binding.showChosenQuizTV2.text = questionStringNumber

      //  for (i in 0..11){
            binding.answer1TV2.text = quizAnswer1[showMarker-1]
            binding.answer2TV2.text = quizAnswer2[showMarker-1]
            binding.answer3TV2.text = quizAnswer3[showMarker-1]
